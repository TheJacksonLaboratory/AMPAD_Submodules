...
module.names <- module.names[grep("TCX", module.names)]
```
...
saveRDS(eigengenes, file=paste0("clean_data/3_iterative_WGCNA_cleaning/mayo_eigengenes.RDS"))
saveRDS(submodule.labels, file=paste0("clean_data/3_iterative_WGCNA_cleaning/mayo_submodule_labels.RDS"))
saveRDS(submodule.sig.genes, file=paste0("clean_data/3_iterative_WGCNA_cleaning/mayo_submodule_sig_genes.RDS"))
...
ggsave(filename=paste0("results/3_iterative_WGCNA_cleaning/mayo_iterative_wgcna_breakdown.png"), width=6, height=5)
```
