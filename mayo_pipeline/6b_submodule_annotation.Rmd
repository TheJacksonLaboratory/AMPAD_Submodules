...
submodules <- readRDS("clean_data/3_iterative_WGCNA_cleaning/mayo_submodule_labels.RDS")
submodule.genes <- readRDS("clean_data/3_iterative_WGCNA_cleaning/mayo_submodule_sig_genes.RDS")
```
...
saveRDS(annots, "clean_data/6_submodule_annotation/mayo_submodule_annots.RDS")
```